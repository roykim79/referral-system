...
import { fetchReferrals, fetchUser, fetchTags, fetchMyOrg } from '../actions';
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators({ fetchReferrals, fetchUser, fetchMyOrg, fetchTags }, dispatch)
}
const mapStateToProps = ({ auth, myOrg }) => {
  return { auth, myOrg };
}
